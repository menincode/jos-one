...
- Skill routing source: `.cursor/commands/skill-agent-routing.md` (`/api-gen`)
- Preferred skills: `api-openapi`, `frameworks-nestjs`
- Recommended agents: `generalPurpose`, `code-reviewer`
