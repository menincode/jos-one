...
- Skill routing source: `.cursor/commands/skill-agent-routing.md` (`/plan`)
- Preferred skills: `write-plan`, `map-codebase`
...
2. **Determine if Plan Should Be Split**
   ...
   **Step 3: Detect Design Reference**
   ...
   - **Design Code Detection**:
     ...
     - If found: Use Design code for folder name (e.g., `docs/04-plans/DS001/`)
...
3. **Save Plan (if --save flag provided)**
   ...
   - Extract directory from save path (e.g., `docs/04-plans/auth.md` → `docs/04-plans/`)
   - Ensure directory exists (create if needed)

   **If plan is split**:
   - **Detect Design Code**: Check if plan references a Design document (e.g., `DS001`, `DS002`)
     - If Design code found: Use Design code for folder name (e.g., `docs/04-plans/DS001/`)
     - If no Design code: Generate plan prefix and number (e.g., `FR001`)
   - **Create sub-folder**: `docs/04-plans/[DESIGN_CODE_OR_PREFIX]/` (e.g., `docs/04-plans/DS001/` or `docs/04-plans/FR001/`)
   - **Create index plan**: `docs/04-plans/[DESIGN_CODE_OR_PREFIX]/index.md` (overview with all sub-plans)
   - **Create sub-plans with unique FR numbers**:
     - Each sub-plan gets its own FR number (FR001, FR002, FR003, etc.)
     - Format: `docs/04-plans/[DESIGN_CODE_OR_PREFIX]/FR[NUMBER]-[phase-name].md`
     - Example: `docs/04-plans/DS001/FR001-setup.md`, `docs/04-plans/DS001/FR002-core.md`, `docs/04-plans/DS001/FR003-api.md`
...
**Index Plan** (`docs/04-plans/[PREFIX][NUMBER]/index.md`):
...
| -------------------- | --------------------- | -------- | ------------- | ------------------------------------------------------------------------ |
| FR001-setup.md       | Setup & Foundation    | 8 tasks  | -             | `/execute-plan docs/04-plans/[DESIGN_CODE]/FR001-setup.md`       |
| FR002-core.md        | Core Implementation   | 12 tasks | Setup (FR001) | `/execute-plan docs/04-plans/[DESIGN_CODE]/FR002-core.md`        |
| FR003-api.md         | API Layer             | 10 tasks | Core (FR002)  | `/execute-plan docs/04-plans/[DESIGN_CODE]/FR003-api.md`         |
| FR004-integration.md | Integration & Testing | 6 tasks  | API (FR003)   | `/execute-plan docs/04-plans/[DESIGN_CODE]/FR004-integration.md` |
...
docs/04-plans/[DESIGN_CODE]/ (e.g., docs/04-plans/DS001/)
...
1. **Start with Setup**: `/execute-plan docs/04-plans/[DESIGN_CODE]/FR001-setup.md`
2. **Continue with Core**: `/execute-plan docs/04-plans/[DESIGN_CODE]/FR002-core.md`
3. **Proceed to API**: `/execute-plan docs/04-plans/[DESIGN_CODE]/FR003-api.md`
4. **Finish with Integration**: `/execute-plan docs/04-plans/[DESIGN_CODE]/FR004-integration.md`
...
**Sub-Plan Example** (`docs/04-plans/[DESIGN_CODE]/FR001-setup.md`):
...
- **FR002-Core**: `/execute-plan docs/04-plans/[DESIGN_CODE]/FR002-core.md`
...
/plan "small feature" → /review-plan docs/04-plans/FR001-feature.md → /execute-plan docs/04-plans/FR001-feature.md
...
# Creates: docs/04-plans/DS001/index.md + sub-plans (if Design DS001 referenced)

# Or: docs/04-plans/FR001/index.md + sub-plans (if no Design reference)

# Execute in dependency order:

/execute-plan docs/04-plans/DS001/FR001-setup.md
/execute-plan docs/04-plans/DS001/FR002-core.md
/execute-plan docs/04-plans/DS001/FR003-api.md
/execute-plan docs/04-plans/DS001/FR004-integration.md
...
- Auto-generates: `docs/04-plans/FR001-[descriptive-name].md`
...
- Creates sub-folder: `docs/04-plans/[DESIGN_CODE]/` (e.g., `docs/04-plans/DS001/`) or `docs/04-plans/[PREFIX][NUMBER]/` (e.g., `docs/04-plans/FR001/`)
- Index plan: `docs/04-plans/[DESIGN_CODE_OR_PREFIX]/index.md` (overview)
- Sub-plans with unique FR numbers: `docs/04-plans/[DESIGN_CODE_OR_PREFIX]/FR[NUMBER]-[phase-name].md`
...
# Generates: docs/04-plans/FR001-user-authentication.md

# Split plan (large feature - automatic)
/plan --save "e-commerce platform"
# If based on Design DS001, generates:
#   docs/04-plans/DS001/index.md (folder uses Design code)
#   docs/04-plans/DS001/FR001-setup.md (each sub-plan has unique FR number)
#   docs/04-plans/DS001/FR002-core.md
#   docs/04-plans/DS001/FR003-api.md
#   docs/04-plans/DS001/FR004-integration.md
# If no Design reference, generates:
#   docs/04-plans/FR001/index.md
#   docs/04-plans/FR001/FR001-setup.md
#   docs/04-plans/FR001/FR002-core.md
#   docs/04-plans/FR001/FR003-api.md
#   docs/04-plans/FR001/FR004-integration.md
...
| `--save=[path]`  | Save plan to file                                 | `--save=docs/04-plans/auth.md` |
...
/plan --depth=5 --save=docs/04-plans/migration.md "database migration"
...
**Result**: Creates `docs/04-plans/DS001/` with:
...
**Result**: Creates `docs/04-plans/FR001/` with:
...
- `docs/04-plans/DS002/index.md`
- `docs/04-plans/DS002/FR001-setup.md` - Models, config (3 tasks)
- `docs/04-plans/DS002/FR002-core.md` - Auth logic (4 tasks)
- `docs/04-plans/DS002/FR003-api.md` - Endpoints (3 tasks)
...
**Result**: Single plan file `docs/04-plans/FR003-add-email-validation.md` even if 20 tasks
