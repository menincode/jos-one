...
- Skill routing source: `.cursor/commands/skill-agent-routing.md` (`/research`)
- Preferred skills: `map-codebase` (default), `audit-dependencies` (dependency/security research)
- Recommended agents: `scout`, `explore`
