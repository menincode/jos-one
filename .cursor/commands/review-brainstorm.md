# /review-brainstorm - Design Document Review Command
...
- Skill routing source: `.cursor/commands/skill-agent-routing.md` (`/review-brainstorm`)
- Preferred skills: `plan-review-experience`, `plan-review-architecture`
- Recommended agents: `experience-reviewer`, `architect`
