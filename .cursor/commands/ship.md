...
- Skill routing source: `.cursor/commands/skill-agent-routing.md` (`/ship`)
- Preferred skills: `verification-gate`, `methodology-finishing-development-branch`, `code-review-loop`
- Recommended agents:
  - `code-reviewer` for final structural pass
  - `security-auditor` if sensitive paths are touched
