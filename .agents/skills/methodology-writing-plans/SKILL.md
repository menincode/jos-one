---
name: methodology-writing-plans
description: Best practices and patterns for Writing Plans
---
...
#   User validation
#     âœ“ validates correct email format (3ms)
#     âœ“ rejects invalid email format (1ms)
# 2 passing
```
